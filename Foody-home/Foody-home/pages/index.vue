        ...
        <div class="space-y-4 pt-2">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-2">
              <span class="w-3 h-3 rounded-full bg-amber-400 pt-0 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
    ...
    <UCard>
      ...
      <UTable :columns="[
        ...
        <template #total-data="{ row }">
          <span class="font-bold text-gray-900 dark:text-white">${{ row.total.toFixed(2) }}</span>
        </template>
