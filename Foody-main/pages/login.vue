...
const doLogin = async (provider: 'email' | 'google' | 'apple' | 'facebook') => {
  ...
  authStore.login(email.value.trim(), provider)
  loading.value = null
...
<template>
  <div class="w-full flex flex-col items-center gap-8 py-10">
    ...
    <div class="flex flex-col items-center gap-3">
      <div class="w-14 h-14 rounded-2xl bg-[#14b891] flex items-center justify-center shadow-lg">
      ...
      <span class="text-white text-2xl font-bold tracking-tight">Foodify</span>
    </div>
    ...
    <div class="w-full max-w-[400px]">
      ...
      <div class="text-center mb-6">
        <h1 class="text-white text-3xl font-bold mb-1">Bienvenido de nuevo</h1>
        <p class="text-gray-400 text-sm">Inicia sesión en tu cuenta de Foodify</p>
      </div>

      <!-- Form card -->
      <div class="bg-white rounded-2xl shadow-2xl px-7 py-7 flex flex-col gap-4">

        <!-- Email input -->
        <div class="flex flex-col gap-1">
          <div
            class="flex items-center border rounded-lg px-3 py-0 transition-all"
          ...
          >
            <input
              ...
              class="flex-1 py-3 text-sm outline-none bg-transparent text-gray-900 placeholder-gray-400"
              @keydown.enter="doLogin('email')"
        ...
        <!-- Email CTA -->
        <button
          class="w-full bg-gray-900 hover:bg-black text-white text-sm font-semibold py-3 rounded-lg transition-colors flex items-center justify-center gap-2 disabled:opacity-60"
        ...
        <div class="flex flex-col gap-2.5">
          ...
          <!-- Google -->
          <button
            class="w-full flex items-center justify-center gap-3 border border-gray-200 hover:border-gray-300 hover:bg-gray-50 text-gray-700 text-sm font-medium py-3 rounded-lg transition-colors disabled:opacity-60"
            :disabled="loading !== null"
          ...
          >
            ...
            <svg v-else width="18" height="18" viewBox="0 0 24 24" fill="#1877F2"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
        ...
        <p class="text-center text-xs text-gray-500 mt-1">
          ¿Aún no tienes cuenta de Foodify?
          <button
